...
func (c *Controller) updateSubscriptionStatus(subscription *spikev1alpha1.Subscription, routerule *istiov1alpha2.RouteRule) error {
	...
	_, err := c.subscriptionclientset.SpikeV1alpha1().Subscriptions(subscription.Namespace).Update(subscriptionCopy)
	return err
}
...
func newRouteRule(subscription *spikev1alpha1.Subscription) *istiov1alpha2.RouteRule {
