...
import (
	...
	scheme "github.com/scothis/stream-spike/pkg/client/clientset/versioned/scheme"
...
func newSubscriptions(c *SpikeV1alpha1Client, namespace string) *subscriptions {
