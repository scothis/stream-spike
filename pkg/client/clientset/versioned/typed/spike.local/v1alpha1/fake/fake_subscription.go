...
type FakeSubscriptions struct {
	Fake *FakeSpikeV1alpha1
	ns   string
}

var subscriptionsResource = schema.GroupVersionResource{Group: "spike.local", Version: "v1alpha1", Resource: "subscriptions"}

var subscriptionsKind = schema.GroupVersionKind{Group: "spike.local", Version: "v1alpha1", Kind: "Subscription"}
