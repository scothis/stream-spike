...
var brokersResource = schema.GroupVersionResource{Group: "spike.local", Version: "v1alpha1", Resource: "brokers"}

var brokersKind = schema.GroupVersionKind{Group: "spike.local", Version: "v1alpha1", Kind: "Broker"}
