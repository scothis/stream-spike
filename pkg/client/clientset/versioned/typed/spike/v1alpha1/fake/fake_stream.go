...
var streamsResource = schema.GroupVersionResource{Group: "spike.local", Version: "v1alpha1", Resource: "streams"}

var streamsKind = schema.GroupVersionKind{Group: "spike.local", Version: "v1alpha1", Kind: "Stream"}
