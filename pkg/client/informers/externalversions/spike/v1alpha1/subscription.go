...
import (
	spike_local_v1alpha1 "github.com/scothis/stream-spike/pkg/apis/spike.local/v1alpha1"
	...
	v1alpha1 "github.com/scothis/stream-spike/pkg/client/listers/spike/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.SpikeV1alpha1().Subscriptions(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.SpikeV1alpha1().Subscriptions(namespace).Watch(options)
			},
		},
		&spike_local_v1alpha1.Subscription{},
		resyncPeriod,
		indexers,
	)
}

func defaultSubscriptionInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewSubscriptionInformer(client, v1.NamespaceAll, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc})
}

func (f *subscriptionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&spike_local_v1alpha1.Subscription{}, defaultSubscriptionInformer)
}
