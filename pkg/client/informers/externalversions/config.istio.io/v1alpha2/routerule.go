...
import (
	config_istio_io_v1alpha2 "github.com/scothis/stream-spike/pkg/apis/config.istio.io/v1alpha2"
	...
	v1alpha2 "github.com/scothis/stream-spike/pkg/client/listers/config.istio.io/v1alpha2"
...
func NewFilteredRouteRuleInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&config_istio_io_v1alpha2.RouteRule{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *routeRuleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&config_istio_io_v1alpha2.RouteRule{}, f.defaultInformer)
}
