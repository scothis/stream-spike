	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SpikeV1alpha1().Brokers(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SpikeV1alpha1().Brokers(namespace).Watch(options)
			},
		},
		&spike_local_v1alpha1.Broker{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *brokerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&spike_local_v1alpha1.Broker{}, f.defaultInformer)
}
