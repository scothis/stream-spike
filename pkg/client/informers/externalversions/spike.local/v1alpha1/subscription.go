...
import (
	...
	v1alpha1 "github.com/scothis/stream-spike/pkg/client/listers/spike.local/v1alpha1"
...
func (f *subscriptionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&spike_local_v1alpha1.Subscription{}, f.defaultInformer)
}
